...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bf/bfPoorHouseholdsSubsidy/list1">贫困户惠农补贴列表</a></li>
		...
		<li class="active"><a href="${ctx}/bf/bfPoorHouseholdsSubsidy/form?type=0&years=${subsidyModel.years}&office.id=${subsidyModel.office.id}">贫困户惠农补贴<shiro:hasPermission name="bf:bfPoorHouseholdsSubsidy:edit">${not empty bfPoorHouseholdsSubsidy.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="bf:bfPoorHouseholdsSubsidy:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="subsidyModel" action="${ctx}/bf/bfPoorHouseholdsSubsidy/save" method="post" class="form-horizontal">
		...
		<table style="border: 0px;">
			...
			<tr>
				...
				<%--<td>身份证号</td>--%>
				<td>户口本号</td>
				<td style="width: 100px!important;">一折通账号</td>
				<td>开户银行</td>
				<td>家庭住址</td>
				<td>补贴项目名称</td>
				<td>补贴总量/补贴面积</td>
			...
			<tr>
				...
				<td class="bg-white">
					...
					<input type="hidden" name="holds[${status.index}].type" value="0" class="type"/>
	...
	$(function(){
		...
		$(".add-tr-btn").click(function(){
			...
			var trHtml =
				...
				'<input type="hidden" name="holds[' + _len + '].type" value="0" class="type">' +
