	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#trade-right").on("click",'.tlb',function () {
				top.mainFrame.recruitRoleAddOrDel($(this).html());
		    });
		...
		function buildHyHtml(){
			var hyHtml = "";
			var hyDetailHtml = "";
	        for(var i=0;i<recruit_zn_data.length;i++){
	        	var data = recruit_zn_data[i];
	        	if(i==0){
	        	...
	        	for(var j=0;j<category.length;j++){
	        		...
	        		var categoryName = recruit_zn_data_detail[categoryId];
