...
<script src="${ctxStatic}/jquery-validation/1.11.1/jquery-validate.bootstrap-tooltip.js"></script>
	...
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bt/bfPoorstudentsFeecollection/">个人补贴登记列表</a></li>
		<%-- MemberId=${bfPoorstudentsFeecollection.student.id} --%>
		<li class="active"><a href="${ctx}/bt/bfPoorstudentsFeecollection/form?office.id=${bfPoorstudentsFeecollection.office.id}&years=${bfPoorstudentsFeecollection.years}">个人补贴登记<shiro:hasPermission name="bt:bfPoorstudentsFeecollection:edit">${not empty bfPoorstudentsFeecollection.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="bt:bfPoorstudentsFeecollection:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
		...
		<div id="tab-1" class="content-detail">
			...
			<table style="border: 0px;">
				...
				<tr class="bg-white">
					...
					<td>
						<form:input path="feeCollection[${status.index}].capital" htmlEscape="false" maxlength="200" class="capital input-xlarge required decimal"/>
					</td>
					<td>
...
//							'<input name="feeCollection['+_len+'].cmsProject.title" class="projectTitle required" type="text" >'+
							...
							'</td>' +
							'<td class="bg-white">' +
							'<input id="feeCollection'+_len+'.capital" name="feeCollection['+_len+'].capital" class="capital required decimal" type="text" >'+
							'</td>' +
							'<td class="bg-white">' +
