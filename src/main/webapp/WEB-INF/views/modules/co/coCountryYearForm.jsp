...
<div class="content tabs f-clear">
	<ul class="content-nav">
		...
		<li><a href="${ctx}/co/coLaborSituation/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">贫困户劳动力情况表</a></li>
		<li><a href="${ctx}/co/coHouseSecurity/form?coMain.coId=${coCountryYear.id}&coMain.type=5">住房保障达标情况统计表</a></li>
		<li><a href="${ctx}/co/coHouseSituation/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">住房保障未达标户名单情况表</a></li>
		...
		<li><a href="${ctx}/co/coInsuranceNameList/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">未购买医疗或商业保险情况名单</a></li>
		<li><a href="${ctx}/co/coIllTreatment/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">患病救治和补助报销情况统计</a></li>
		...
		<li><a href="${ctx}/co/coSafeDrink/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">安全饮水达标情况统计</a></li>
		<li><a href="${ctx}/co/coDrinkSituation/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">未达到安全饮水户名单</a></li>
		<li><a href="${ctx}/co/coRoadSituation/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">通硬化路情况表</a></li>
		<li><a href="${ctx}/co/coTwentyRoad/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">20户以上通路情况表</a></li>
		...
		<li><a href="${ctx}/co/coCultureSituation/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">篮球场，文化室或戏台情况表</a></li>
		<li><a href="${ctx}/co/coNetwork/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">通网络宽带情况表</a></li>
		...
		<li><a href="${ctx}/co/coTvOnline/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">农户能看电视或上网情况统计表</a></li>
		<li><a href="${ctx}/co/coDigitalCount/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">未有数码设备名单</a></li>
		<li><a href="${ctx}/co/coIncidenceOfPoverty/form?coId=${coCountryYear.id}&countryId=${coCountryYear.area.id}">贫困发生率统计表</a></li>
