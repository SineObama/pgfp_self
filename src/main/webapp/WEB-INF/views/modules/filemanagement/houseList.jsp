...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/filemanagement/fileManagement/houseList">贫困户列表</a></li>
    ...
    <ul class="nav nav-tabs nav-year">
        <c:forEach items="${yearList}" var="year">
            <c:if test="${card.years == year}">
                <li class="active"><a href="${ctx}/filemanagement/fileManagement/houseList?years=${year}">${year}</a></li>
            </c:if>
            <c:if test="${card.years != year}">
                <li><a href="${ctx}/filemanagement/fileManagement/houseList?years=${year}">${year}</a></li>
            </c:if>
        </c:forEach>
    </ul>
</c:if>
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="card" varStatus="status">
        <tr>
            ...
            <td>
                &nbsp;&nbsp;<a href="${ctx}/filemanagement/fileManagement/form?id=${card.id}">查看档案清单</a>&nbsp;&nbsp;
            </td>
        </tr>
    </c:forEach>
    </tbody>
