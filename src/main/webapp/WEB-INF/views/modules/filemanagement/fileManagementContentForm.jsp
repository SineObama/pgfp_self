...
<div class="form-horizontal">
	<div class="view">
		<c:if test="${fileManagement != null and fileManagement.content != null}"><br/>
			${contentText}
			<br/><br/>
			<div>
		...
		<c:if test="${fileManagement == null || fileManagement.content == null}">
			<div>
	...
	<div class="edit">
		<form:form modelAttribute="fileManagement" action="${ctx}/filemanagement/fileManagement/saveContent" method="post" >
			<input type="hidden" name="id" value="${fileManagement.id}"/>
			<input type="hidden" name="content.id" value="${fileManagement.content.id}"/>
