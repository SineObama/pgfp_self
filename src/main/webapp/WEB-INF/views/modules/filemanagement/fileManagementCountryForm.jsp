...
<ul class="nav nav-tabs">
	<li><a href="${ctx}/filemanagement/fileManagementCountry/countryList?type=${areaFileManagement.type}">${areaFileManagement.countryLevel}档案目录管理列表</a></li>
	<li class="active" style="list-style:none;">
		<a href="${ctx}/filemanagement/fileManagementCountry/form?id=${areaFileManagement.id}&type=${areaFileManagement.type}">
			${areaFileManagement.area.name}档案目录管理
		</a>
	</li>
</ul>
...
<script type="text/javascript">
    ...
    var areaFileManagement = ${fns:toJson(areaFileManagement)};
        ...
        callback: {
            ...
            onClick: function(event, treeId, treeNode){
                ...
                if(id != '0' && id.length >= 32){//如果是新增加的目录节点，则不能跳转，因为还没有保存如数据库
                    $('#contentFrame').attr("src","${ctx}/filemanagement/fileManagementCountry/getContent?id="+id);
                }
            }
        }
    };
    ...
    function onRemove(e, treeId, treeNode) {
        ...
        $.ajax({
            type: 'POST',
            url: ctx+"/filemanagement/fileManagementCountry/deleteFileNode",
...
//        alert("删除成功");
    ...
    function onRename(e, treeId, treeNode, isCancel) {
        ...
        var data = {"nodeId":nodeObject.id , "pId":nodeObject.pId , "name":nodeObject.name , "areaFileManagementId":areaFileManagement.id , "years":areaFileManagement.years};
        $.ajax({
            type: 'POST',
            url: ctx+"/filemanagement/fileManagementCountry/saveFileNode",
            data: data,
            dataType: "JSON",
            success: function(msg){
                if(msg.responseText == 'success'){
...
//                console.log(msg);
    ...
    function refreshTree() {
        $.getJSON("${ctx}/filemanagement/fileManagementCountry/treeData?aFMId="+areaFileManagement.id, function (data) {//刷新的时候
//            console.log(data)
