...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="${ctx}/record/demandAndSituation/formD?countryBasicId=${countryBasic.id}">帮扶需求及帮扶情况<shiro:hasPermission name="record:demandAndSituation:edit">${not empty demandAndSituation.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="record:demandAndSituation:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
<div class="content tabs f-clear">
	<ul class="content-nav">
		<li><a href="${ctx}/record/natureBaseCountryBasic/form?id=${countryBasic.id}">基本情况</a></li>
	...
	<c:choose>
		...
		<form:form id="inputForm" modelAttribute="countryBasic" action="${ctx}/record/demandAndSituation/saveD" method="post" class="form-horizontal">
			<form:hidden path="id"/>
			<form:hidden path="years"/>
			<c:forEach var="temp" begin="0" end="34" step="1">
				<form:hidden path="demans[${temp}].id"/>
				<form:hidden path="demans[${temp}].type" value="2"/>
			</c:forEach>
		<sys:message content="${message}"/>
		<table>
			<tbody>
			<tr>
				<td colspan="2" rowspan="2" class="fir-td"><span>需求项目</span></td>
				<td rowspan="2" class="thr-td"><span>单位</span></td>
				<td rowspan="2" class="thr-td"><span>建设规模</span></td>
				<td rowspan="2" class="thr-td"><span>建设内容</span></td>
				<td rowspan="2" class="thr-td"><span>建设地点</span></td>
				<td colspan="2" class="thr-td"><span>投资估算（万元）</span></td>
				<td style="text-align: center;" colspan="3" class="thr-td"><span>覆盖范围</span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="村（组）路" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="公里" readonly="true"></td>
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[0].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[0].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[0].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[0].totalPrice}' pattern='#0.##'/>"/>
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--&lt;%&ndash;<input type="text" name="demans[0].villageNumber" value="${countryBasic.demans[0].villageNumber}" />&ndash;%&gt;--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[0].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[0].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--&lt;%&ndash;<input type="text" name="demans[0].poorHouseholdNumber" value="${countryBasic.demans[0].poorHouseholdNumber}" />&ndash;%&gt;--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="生产便道（机耕路）" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="公里" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[1].villageNumber" value="${countryBasic.demans[1].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[1].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[1].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[1].poorHouseholdNumber" value="${countryBasic.demans[1].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="建档立卡贫困户入户路" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="处" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[2].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[2].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[2].villageNumber" value="${countryBasic.demans[2].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[2].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[2].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[2].poorHouseholdNumber" value="${countryBasic.demans[2].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td rowspan="6" class="thr-td"><span>2.人饮和灌溉设施</span></td>
				<td class="sec-td"><input type="text" class="inp-left" value="集中供水点" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="处" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[3].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[3].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[3].villageNumber" value="${countryBasic.demans[3].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[3].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[3].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[3].poorHouseholdNumber" value="${countryBasic.demans[3].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="供水管道" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[4].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[4].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[4].villageNumber" value="${countryBasic.demans[4].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[4].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[4].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[4].poorHouseholdNumber" value="${countryBasic.demans[4].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="灌溉渠" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="公里" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[5].unitPrice" maxlength="11" class="decimal"value="<fmt:formatNumber value='${countryBasic.demans[5].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="灌溉塘（堰、井）" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="口" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[6].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[6].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[6].villageNumber" value="${countryBasic.demans[6].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[6].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[6].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[6].poorHouseholdNumber" value="${countryBasic.demans[6].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td "><input type="text" class="inp-left" value="地头水柜" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="个" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[7].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[7].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[7].villageNumber" value="${countryBasic.demans[7].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[7].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[7].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[7].poorHouseholdNumber" value="${countryBasic.demans[7].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="小型灌站" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="个" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[8].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[8].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[8].villageNumber" value="${countryBasic.demans[8].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[8].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[8].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[8].poorHouseholdNumber" value="${countryBasic.demans[8].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="生产用电输变电线路和设施" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[9].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[9].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[9].villageNumber" value="${countryBasic.demans[9].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[9].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[9].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[9].poorHouseholdNumber" value="${countryBasic.demans[9].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="贫困户生活生产用电输变电线路和设施" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[10].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[10].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[10].villageNumber" value="${countryBasic.demans[10].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[10].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[10].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[10].poorHouseholdNumber" value="${countryBasic.demans[10].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="移动基站" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="处" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[11].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[11].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[11].villageNumber" value="${countryBasic.demans[11].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[11].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[11].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[11].poorHouseholdNumber" value="${countryBasic.demans[11].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="乡镇到自然村光缆线路" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[12].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[12].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[12].villageNumber" value="${countryBasic.demans[12].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[12].householdNumber"  maxlength="8" class="int" value="${countryBasic.demans[12].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[12].poorHouseholdNumber" value="${countryBasic.demans[12].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="自然村内光缆线路和接入设备" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[13].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[13].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[13].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[13].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[13].villageNumber" value="${countryBasic.demans[13].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[13].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[13].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[13].poorHouseholdNumber" value="${countryBasic.demans[13].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="公共卫生厕所" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="个" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[14].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[14].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
				...
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[14].villageNumber" value="${countryBasic.demans[14].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[14].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[14].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[14].poorHouseholdNumber" value="${countryBasic.demans[14].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="垃圾集中收集点" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="个" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[15].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[15].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[15].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[15].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[15].villageNumber" value="${countryBasic.demans[15].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[15].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[15].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[15].poorHouseholdNumber" value="${countryBasic.demans[15].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="污水处理" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="处" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[16].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[16].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[16].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[16].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[16].villageNumber" value="${countryBasic.demans[16].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[16].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[16].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[16].poorHouseholdNumber" value="${countryBasic.demans[16].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="集中沼气池" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="口" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[17].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[17].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[17].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[17].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[17].villageNumber" value="${countryBasic.demans[17].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[17].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[17].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[17].poorHouseholdNumber" value="${countryBasic.demans[17].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="两旁绿化" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[18].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[18].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[18].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[18].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[18].villageNumber" value="${countryBasic.demans[18].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[18].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[18].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[18].poorHouseholdNumber" value="${countryBasic.demans[18].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="旅游村停车场" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="处" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[19].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[19].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[19].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[19].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[19].villageNumber" value="${countryBasic.demans[19].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[19].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[19].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[19].poorHouseholdNumber" value="${countryBasic.demans[19].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="防洪堤" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[20].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[20].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[20].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[20].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[20].villageNumber" value="${countryBasic.demans[20].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[20].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[20].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[20].poorHouseholdNumber" value="${countryBasic.demans[20].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="护坡" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="千米" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[21].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[21].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[21].totalPrice" maxlength="11" class="decimal"value="<fmt:formatNumber value='${countryBasic.demans[21].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[21].villageNumber" value="${countryBasic.demans[21].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[21].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[21].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[21].poorHouseholdNumber" value="${countryBasic.demans[21].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="就地安置" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[22].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[22].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[22].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[22].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[22].villageNumber" value="${countryBasic.demans[22].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[22].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[22].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[22].poorHouseholdNumber" value="${countryBasic.demans[22].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="中心村安置" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[23].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[23].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[23].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[23].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[23].villageNumber" value="${countryBasic.demans[23].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[23].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[23].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[23].poorHouseholdNumber" value="${countryBasic.demans[23].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="乡（镇）安置" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[24].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[24].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[24].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[24].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[24].villageNumber" value="${countryBasic.demans[24].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[24].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[24].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[24].poorHouseholdNumber" value="${countryBasic.demans[24].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="县城安置" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[25].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[25].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[25].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[25].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[25].villageNumber" value="${countryBasic.demans[25].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[25].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[25].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[25].poorHouseholdNumber" value="${countryBasic.demans[25].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="工业园区" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[26].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[26].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[26].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[26].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[26].villageNumber" value="${countryBasic.demans[26].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[26].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[26].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[26].poorHouseholdNumber" value="${countryBasic.demans[26].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="旅游区" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="户" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[27].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[27].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[27].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[27].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[27].villageNumber" value="${countryBasic.demans[27].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[27].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[27].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[27].poorHouseholdNumber" value="${countryBasic.demans[27].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td rowspan="6" class="thr-td"><span>8.特色产业发展</span></td>
				<td class="sec-td"><input type="text" class="inp-left" value="种植类" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="亩" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[28].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[28].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[28].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[28].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[28].villageNumber" value="${countryBasic.demans[28].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[28].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[28].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[28].poorHouseholdNumber" value="${countryBasic.demans[28].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="中药材类" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="亩" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[29].unitPrice" maxlength="11"  class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[29].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[29].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[29].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[29].villageNumber" value="${countryBasic.demans[29].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[29].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[29].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[29].poorHouseholdNumber" value="${countryBasic.demans[29].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="养殖类" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="-" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[30].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[30].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[30].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[30].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[30].villageNumber" value="${countryBasic.demans[30].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[30].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[30].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[30].poorHouseholdNumber" value="${countryBasic.demans[30].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="水果类" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="亩" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[31].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[31].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[31].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[31].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[31].villageNumber" value="${countryBasic.demans[31].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[31].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[31].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[31].poorHouseholdNumber" value="${countryBasic.demans[31].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td"><input type="text" class="inp-left" value="坚果类" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="亩" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[32].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[32].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[32].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[32].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[32].villageNumber" value="${countryBasic.demans[32].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[32].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[32].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[32].poorHouseholdNumber" value="${countryBasic.demans[32].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				<td class="sec-td"><input type="text" class="inp-left" value="其他类" readonly="true"></td>
				<td class="sec-td"><input type="text" class="inp-left" value="-" readonly="true"></td>
				<td class="sec-td bg-white">
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[33].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[33].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[33].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[33].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[33].villageNumber" value="${countryBasic.demans[33].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[33].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[33].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[33].poorHouseholdNumber" value="${countryBasic.demans[33].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
			...
			<tr>
				...
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].other901" value="${countryBasic.demans[34].other901}" />
				</td>
				<td class="sec-td bg-white"><input type="text" name="demans[34].other902" value="${countryBasic.demans[34].other902}" /></td>
				<td class="sec-td bg-white">
					<input type="hidden" name="demans[34].serial" value="34"/>
					<input type="text" name="demans[34].scale" value="${countryBasic.demans[34].scale}" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].idx" value="${countryBasic.demans[34].idx}" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].constructionSite" value="${countryBasic.demans[34].constructionSite}" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].unitPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[34].unitPrice}' pattern='#0.##'/>" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].totalPrice" maxlength="11" class="decimal" value="<fmt:formatNumber value='${countryBasic.demans[34].totalPrice}' pattern='#0.##'/>" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[34].villageNumber" value="${countryBasic.demans[34].villageNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].householdNumber" maxlength="8" class="int" value="${countryBasic.demans[34].householdNumber}" />
				</td>
				<%--<td class="sec-td bg-white">--%>
					<%--<input type="text" name="demans[34].poorHouseholdNumber" value="${countryBasic.demans[34].poorHouseholdNumber}" />--%>
				<%--</td>--%>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].peopleNumber" maxlength="8"  class="int" value="${countryBasic.demans[34].peopleNumber}" />
				</td>
				<td class="sec-td bg-white">
					<input type="text" name="demans[34].implementAndCompletion" value="${countryBasic.demans[34].implementAndCompletion}" />
				</td>
			</tr>
