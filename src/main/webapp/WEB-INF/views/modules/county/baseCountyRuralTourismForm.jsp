...
<body>
	<ul class="nav nav-tabs">
		...
		<%-- <li><a href="${ctx}/county/baseCountyRuralTourism/">乡村旅游列表</a></li> --%>
		<li class="active"><a href="${ctx}/county/baseCountyRuralTourism/form?baseCountyInfoId=${baseCountyKeyWorkInfo.baseCountyInfoId}&type=6">乡村旅游<shiro:hasPermission name="county:baseCountyRuralTourism:edit">${not empty baseCountyKeyWorkInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="county:baseCountyRuralTourism:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="baseCountyKeyWorkInfo" action="${ctx}/county/baseCountyRuralTourism/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table>
                <tbody>
                <tr>
                    <td class="fir-td"><span>C57 开展乡村旅游的贫困村村数（个）</span></td>
                    <td class="sec-td bg-white">
                    	<form:input path="ruralTourismVillages" maxlength="8" htmlEscape="false" class="input-xlarge  digits"/>
                    </td>
                    <td class="thr-td"><span>C59 乡村旅游从业人员数（人）</span></td>
                    <td class="fou-td bg-white">
                    	<form:input path="numberOfEmployee" maxlength="8" htmlEscape="false" class="input-xlarge  digits"/>
                    </td>
                </tr>
                <tr>
                    <td class="fir-td"><span>C58 乡村旅游游客接待量（万人次）</span></td>
                    <td class="sec-td bg-white">
                        <form:input path="touristReceipts" htmlEscape="false" maxlength="11" class="input-xlarge  decimal"/>
                    </td>
                    <td class="thr-td"><span>C60 乡村旅游总收入（万元）</span></td>
                    <td class="fou-td bg-white">
						<form:input path="ruralTourismRevenue" maxlength="11" htmlEscape="false" class="input-xlarge  decimal"/>
                    </td>
                </tr>
                </tbody>
        </table>
